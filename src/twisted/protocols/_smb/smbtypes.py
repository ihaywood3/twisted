...
from twisted.protocols._smb.base import (
    byte,
    short,
    medium,
    long,
...
# filesystem attributes (FileFsAttributeInformation.fs_attributes)
...
# The volume supports transactions.<137>
...
# The file system supports the Encrypted File System (EFS).<138>
...
# The file system supports remote storage.<139>
